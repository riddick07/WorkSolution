...
<body class="body-t">
    <div class="wrapper">
        ...
        <form id="loginForm" class="m-top pagination-centered" action="j_spring_security_check" method="post">
            <input id="login" name="j_username" class="m-top login-f" type="text" placeholder="Username" style="padding-left: 0; padding-right: 0"><br/>
            <input id="password" name="j_password" class="login-f" type="password" placeholder="Password" style="padding-left: 0; padding-right: 0"><br/>
